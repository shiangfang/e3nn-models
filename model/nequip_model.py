...
class NequIPEnergyModel_Efield(hk.Module):
    def __init__(
        self,
        *,
        output_irreps : e3nn.Irreps,
    ...
    def __call__(
        ...
        h_node_L0 = Linear(irreps_out=second_to_final_irreps)(h_node)
        h_node_L0 = Linear(irreps_out=final_irreps)(h_node_L0).array
        
        expansion2_matrix = e3nn.reduced_tensor_product_basis("ij=ji", i="1x1o")
    ...
    **kwargs,
    ...
    def model_(
        ...
        contributions = nequip(
            vectors, node_z, senders, receivers, efield
...
def NequIP_JAXMD_model_Efield(
    ...
    **kwargs,
    ...
    def model_(
        ...
        nequip = NequIPEnergyModel_Efield(output_irreps="0e", **kwargs)
        ...
        #print('contributions',contributions.shape,contributions)
